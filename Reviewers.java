...
public class Reviewers extends User {
	...
	public Reviewers(String t, String fn, String sn, String e, String p, String u) throws SQLException, NoSuchAlgorithmException {
		super(t, fn, sn, e, p, u);
	...
	public void submitInitialVerdict(String status) throws SQLException, NoSuchAlgorithmException {
		...
		String queryrev = "UPDATE review "
						+ "set summary = ? , typos = ? , judgement = ? , status = ? "
